namespace ConsoleApp_eftest
{
    ...
    [Table("ERP.BIZ_REC_WATER_VIEW")]
    public partial class BIZ_REC_WATER_VIEW
    {
        [StringLength(36)]
        ...
        [StringLength(200)]
        public string ASSIGNED_COMPANY_NAME { get; set; }

        public decimal? TOTALDIVIDE { get; set; }

        public decimal? APPROVESTATUS { get; set; }
    }
}
